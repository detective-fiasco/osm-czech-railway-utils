...
- [Signal tagging variants](https://overpass-turbo.eu/s/2jiA) - Usage comparison of different types of czech railway signal tagging. (Blue `CZ`, Green `CZ-D1:`, Yellow `yes`, Red `Cs-D1:`, Purple has a note)
